...
import CaterPilot from "../assets/caterpilot.png"
    ...
    <nav className="bg-white/30 sticky top-0 backdrop-blur-lg text-black p-3 z-50">
      <div className="mx-auto flex justify-between items-center">
        <div className="text-black font-bold text-3xl">
          <Link to={"/"}>
            <img src={CaterPilot} alt="CaterPilot" className="h-16 w-16 inline" />
            <p className="px-4 inline">CaterPilot</p>
          </Link>
        </div>
        <div className="font-mono space-x-8 sm:space-x-4 text-xl">
          ...
          <Link to={"/records"} className="text-black hover:text-gray-400">
            Records
          </Link>
          <Link to={"/new"} className="text-black hover:text-gray-400">
            New
          </Link>
              ...
              {isLoggedIn ? (
                <>
                  ...
                  <button
                    ...
                    className="w-full text-left block px-4 py-2 text-black hover:bg-gray-100">
                    Logout
                  </button>
                </>
              ) : (
